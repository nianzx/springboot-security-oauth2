...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Resource
    //可以不需要指定@Qualifier，但是在SecurityConfig中一定要有重写authenticationManagerBean并将其指定成@Bean，springboot2.0新增
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        clients
                ...
                .secret("{noop}nianzx");//springboot2.0改了加密方式，这边需要加上{noop},表示不加密，其他的还有{bcrypt}、{ldap}、{MD4}、{MD5}、{pbkdf2}、{scrypt}、{SHA-1}、{SHA-256}、{sha256}具体请查阅官方文档
